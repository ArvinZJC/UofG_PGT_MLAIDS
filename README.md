...
1. The IPYNB file can be opened and edited in Visual Studio Code (if supported). By 12 March 2021, everything looks good with the code editor (Version: 1.54.2). As an option, you can also use Jupyter Notebook in Anaconda. The primary packages used in the development are listed in the following table.
